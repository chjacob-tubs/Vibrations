...
np.save(os.path.join(outdir,'V1_g16.npy'), v1)
np.save(os.path.join(outdir,'Dm1_g16.npy'), dm1)
...
np.save(os.path.join(outdir,'V2_g16.npy'), v2)
np.save(os.path.join(outdir,'Dm2_g16.npy'), dm2)
