...
#finding path to test data:
install_path = os.path.dirname(vib.__file__)
path = os.path.join(install_path,"tests")
testdata = [os.path.join(path,'data'),os.path.join(path,'ala6_amideI')]
