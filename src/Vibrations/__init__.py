...
U{ChemPhysChem 15 (2014) 3365 <http://dx.doi.org/10.1002/cphc.201402251>},
U{J. Chem. Phys. 144 (2016) 164111 <http://dx.doi.org/10.1063/1.4947213>}, and
U{J. Phys. Chem. Lett. 7 (2016) 3084
...
packages, extended with NumPy and SciPy. However for typical usage,
where normal modes from previous calculations are read in,
the potential energy surfaces are
calculated with QM programs, another packages are needed
 - U{LocVib package<http://www.christophjacob.eu/>}
for reading in normal modes, localizing them, etc.
 - U{PyADF suite<http://pyadf.org>} as an interface to QM codes,
for calculating potential energy and property surfaces
...
print(' *')
print(' *  Vibrations - a Python Code for Anharmonic Theoretical\
 Vibrational Spectroscopy')
print(' *  Copyright (C) 2014-2023 by Pawel T. Panek,\
 Adrian A. Hoeske, Julia Brüggemann,')
print(' *  Michael Welzel, and Christoph R. Jacob.')
print(' *')
print(' *     Vibrations is free software: you can redistribute it\
 and/or modify')
print(' *     it under the terms of the GNU General Public License as\
 published by')
print(' *     the Free Software Foundation, either version 3 of the License,\
 or')
...
print(' *')
print(' *     You should have received a copy of the GNU\
 General Public License')
print(' *     along with Vibrations.  If not, see\
